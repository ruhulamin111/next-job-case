...
function Header() {
    ...
    return (
        <div>
            <header className="sticky top-0 z-40 bg-white dark:bg-black flex items-center justify-around py-1.5 px-3 focus-within:shadow-lg">
                {/* Left */}
                <div className="flex items-center space-x-2 w-full max-w-xs">
                    {mounted && (
                        <>
                            {resolvedTheme === "dark" ? (
                                <Image src='https://cdn-icons-png.flaticon.com/512/174/174857.png' width={55} height={55} alt="" />
                            ) : (
                                <Image src='https://cdn-icons-png.flaticon.com/512/174/174857.png' width={55} height={55} alt="" />
                            )}
                        </>
                ...
                <div className="flex items-center space-x-6">
                    <HeaderLink Icon={HomeRoundedIcon} text="Home" feed activ />
